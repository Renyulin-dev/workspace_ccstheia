...
float line_follower(float kp, float ki, float kd)
{
    ...
    // 左转逻辑
    else if ((!s[0] && s[3] && s[4] && s[5] && s[6] && s[7])                   /* 0 - - 1 1 1 1 1 */
           || (!s[1] && !s[3] && s[4] && s[5] && s[6] && s[7])                /* - 0 - 0 1 1 1 1 */
           || (!s[2] && !s[4] && s[5] && s[6] && s[7])                        /* - - 0 - 0 1 1 1 */
    ...
    // 右转逻辑
    else if ((s[0] && s[1] && s[2] && s[3] && s[4] && !s[7])                   /* 1 1 1 1 1 - - 0 */
           || (s[0] && s[1] && s[2] && s[3] && !s[4] && !s[6])                /* 1 1 1 1 0 - 0 - */
           || (s[0] && s[1] && s[2] && !s[3] && !s[5])                        /* 1 1 1 0 - 0 - - */
